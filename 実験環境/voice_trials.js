...
const all_stimuli = Array.from({ length: 100 }, (_, i) => {
  ...
  return {
    ...
    stim_num: num,
    speaker_id: `jvs${num}`,
    speaker_gender: speaker_gender_map[i],
    file: `./assets/main/VOICEACTRESS100_026_${num}.wav`,
  };
});

// 100音声を4グループに分けて参加者ごとに1グループだけ提示します。
const groups = [
...
const group_id = Math.floor(Math.random() * 4);
...
const practice_stimuli = [
  {
    ...
    speaker_gender: null,
    file: "./assets/practice/VOICEACTRESS100_051.wav",
  },
  {
    id: "practice_2",
    stim_num: null,
    ...
    speaker_gender: null,
    file: "./assets/practice/VOICEACTRESS100_051 copy.wav",
  },
];

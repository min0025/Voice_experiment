// スクリーニング用刺激
const scr_stimuli = [
  {name: "quiet", file: "../スクリーニング聴取課題/tone_quiet.wav"},
  {name: "normal", file: "../スクリーニング聴取課題/tone_normal.wav"},
  {name: "anti", file: "../スクリーニング聴取課題/tone_antiphase.wav"}
];
...
const volume_adjustment = {
  ...
  stimulus: `
    ...
    <div style="text-align: center; margin-bottom: 30px;">
      ...
      <audio id="volumeAudio" src="../練習試行用音声/VOICEACTRESS100_031.wav"></audio>
    </div>
